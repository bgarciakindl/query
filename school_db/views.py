...
def problem_two(request):
    instructors= Instructor.objects.filter(hire_date__year__lte = 2010)
...
def problem_four(request):
  ...
  instrutors = Instructor.objects.all()
  student_count=0
  course_count =0
  instructor_count =0
  for student in students:
...
def problem_five(request):
  student= Student.objects.create(first_name = "Jadzia", last_name= "Dax", year= 2022, gpa= 3.0)
